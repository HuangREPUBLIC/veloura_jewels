...
<div class="jewelry-page">
    ...
    <?php else: ?>
        <div class="product-grid">
            ...
            <?php if ($isAdmin): ?>
            <a href="<?= $this->Url->build(['controller' => 'Products', 'action' => 'add', '?' => ['type' => 'home_decor']]) ?>" class="product-card-link">
            ...
            <?php foreach ($products as $product): ?>
                ...
                <a href="<?= $this->Url->build('/home-decor/view/' . $product->id) ?>?back=/home-decor" class="product-card-link">
