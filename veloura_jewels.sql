...
INSERT INTO `activity_logs` (`id`, `user_id`, `user_name`, `action`, `model`, `model_id`, `model_label`, `changes`, `created`, `is_archived`) VALUES
                                                                                                                                                  ...
                                                                                                                                                  (8, 6, 'admin@test.com', 'updated', 'Product', 57, 'Art Deco Adjustable Necklace', '{\"sizes\":{\"from\":[],\"to\":[{\"size\":\"One Size\",\"stock\":98}]}}', '2026-05-19 17:01:12', 0);
...
INSERT INTO `categories` (`id`, `name`, `type`, `sizes`) VALUES
                                                             (1, 'Rings', 'jewelry', '[\"Size 5\", \"Size 6\", \"Size 7\", \"Size 8\", \"Size 9\", \"Size 10\", \"Size 11\", \"Size 12\", \"One Size\"]'),
                                                             (2, 'Necklaces', 'jewelry', '[\"One Size\"]'),
                                                             (3, 'Earrings', 'jewelry', '[\"One Size\"]'),
                                                             (4, 'Bracelets', 'jewelry', '[\"One Size\"]'),
                                                             (5, 'Brooches', 'jewelry', '[\"One Size\"]'),
                                                             (6, 'Candles', 'home_decor', '[\"One Size\"]'),
                                                             (7, 'Vases', 'home_decor', '[\"One Size\"]'),
                                                             (8, 'Cushions', 'home_decor', '[\"One Size\"]'),
                                                             (9, 'Wall Art', 'home_decor', '[\"One Size\"]'),
                                                             (10, 'Throws', 'home_decor', '[\"One Size\"]'),
                                                             (11, 'Curtain', 'home_decor', '[\"One Size\"]');
...
INSERT INTO `contact_replies` (`id`, `contact_submission_id`, `subject`, `message`, `sent_at`, `created`, `modified`) VALUES
                                                                                                                          ...
                                                                                                                          (7, 5, 'Re: testing email', 'Hi Customer,\r\nheelo', '2026-05-18 19:54:40', '2026-05-18 19:54:40', '2026-05-18 19:54:40');
...
INSERT INTO `contact_submissions` (`id`, `first_name`, `last_name`, `email`, `subject`, `message`, `captcha_passed`, `is_replied`, `created`, `modified`, `archived`) VALUES
                                                                                                                                                                          (1, 'Jialin', 'Wu', 'jialinwu.island@gmail.com', '', '1', 0, 1, '2026-03-20 02:40:43', '2026-03-24 06:32:52', 0),
                                                                                                                                                                          (3, '11', '11', '11@1.com', '', '1wassadsad', 0, 0, '2026-03-20 02:44:25', '2026-03-20 02:44:25', 0),
                                                                                                                                                                          (4, 'Hey', 'Test', 'Testing@mail.com', 'This is a test subject', 'I want to test the subject', 0, 1, '2026-03-24 06:23:08', '2026-05-19 16:32:13', 0),
                                                                                                                                                                          (5, 'Customer', 'Test', 'test1@u26s1141.iedev.org', 'testing email', 'TEST', 0, 1, '2026-04-22 00:40:01', '2026-05-18 19:54:40', 0),
                                                                                                                                                                          (7, 'Customer', 'Test', 'test1@u26s1141.iedev.org', 'testing email', 'tesret', 0, 0, '2026-04-22 01:16:42', '2026-04-22 01:16:42', 0),
                                                                                                                                                                          (8, 'Customer', 'Test', 'test1@u26s1141.iedev.org', 'testing email', 'wwww', 0, 0, '2026-04-22 01:22:27', '2026-04-22 01:22:27', 0),
                                                                                                                                                                          (9, 'sami', 'Test', 'test1@u26s1141.iedev.org', 'devTesting', 'Testing if email works on dev version', 0, 0, '2026-04-22 01:27:19', '2026-05-19 16:29:36', 1),
                                                                                                                                                                          (10, 'Hunter', 'McConnell', 'hmcc0010@student.monash.edu', 'kj k', 'kjn', 0, 1, '2026-05-07 12:47:45', '2026-05-07 12:49:12', 0),
                                                                                                                                                                          (11, 'Customer', 'Test', 'customer@gmail.com', 'Hello ', 'MEssage', 0, 0, '2026-05-07 13:15:52', '2026-05-07 13:15:52', 0),
                                                                                                                                                                          (12, 'Jialin', 'Wu', 'jialinwu.island@gmail.com', '1qwefghh', '12345', 0, 0, '2026-05-08 00:24:10', '2026-05-08 00:24:10', 0);
...
INSERT INTO `page_content` (`id`, `page_id`, `content_key`, `content_value`, `label`, `content_type`, `sort_order`) VALUES
                                                                                                                        ...
                                                                                                                        (8, 2, 'brand_story_body_2', 'We believe that what you wear and what surrounds you should feel personal. That\'s why no two Veloura pieces are exactly alike.', 'Brand Story (Paragraph 2)', 'textarea', 7),
...
(24, 6, 'body_4', 'Whether it\'s a delicate necklace worn every day, a statement ring for a special occasion, or décor that transforms a house into a home, Veloura Jewels is built around the idea that beauty should feel personal.', 'Story (Paragraph 4)', 'textarea', 5),
                                                                                                                        ...
                                                                                                                        (28, 2, 'brand_story_title', 'About Veloura Jewels', 'Brand Story Title', 'textarea', 5),
...
(40, 2, 'about_us_video', 'handmadeDiamondRing.mp4', 'About Us Video', 'video', 9),
...
INSERT INTO `wishlists` (`id`, `user_id`, `product_id`, `created`) VALUES
                                                                       ...
                                                                       (21, 6, 45, '2026-05-12 22:27:45'),
                                                                       (22, 10, 15, '2026-05-13 00:58:10'),
                                                                       (23, 10, 14, '2026-05-13 00:58:11'),
                                                                       (24, 10, 13, '2026-05-13 00:58:12'),
                                                                       (25, 10, 54, '2026-05-13 00:58:13'),
                                                                       (26, 10, 53, '2026-05-13 00:58:14'),
                                                                       (27, 10, 45, '2026-05-13 00:58:17'),
