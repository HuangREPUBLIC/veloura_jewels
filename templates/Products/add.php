 ...
 * @var array $types
 */
$this->assign('crumbRecord', 'Add Product');
?>
<div class="page-header-row">
    <div>
        <p class="cms-eyebrow">Products</p>
        <h2 class="page-title"><?= __('Add Product') ?></h2>
    </div>
    ...
    <div class="cms-group-fields">
        ...
        <div class="cms-field-row">
            ...
            <div class="cms-field">
                ...
                <select name="category_id" id="categories-select" class="cms-input" required disabled
        ...
        <div class="cms-field">
            <label class="cms-label" for="Images">Images <span style="color:red">*</span></label>
