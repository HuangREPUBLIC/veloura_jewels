...
<div class="admin-wrapper">
    <div class="admin-dashboard">
        ...
        <?php if ($role === 'admin'): ?>
            <div class="dashboard-tools-header">
                <h2>Admin Tools</h2>
            </div>

            <div class="dashboard-tools-grid">
                <a href="<?= $this->Url->build(['controller' => 'Schedule', 'action' => 'add']) ?>" class="dashboard-card">
                    <div class="dashboard-icon">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#786c3b" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="4" width="18" height="17" rx="2"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/>
                        </svg>
                    </div>
                    <div class="dashboard-content">
                        <h3>Staff Schedule</h3>
                        <p>Manage weekly staff shifts.</p>
                    </div>
                </a>

                <a href="<?= $this->Url->build(['controller' => '', 'action' => '']) ?>" class="dashboard-card">
                    <div class="dashboard-icon">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#786c3b" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
